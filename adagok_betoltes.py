...
# Táblák létrehozása az ER diagram alapján
cursor.execute('''
...
# Adatok betöltése az 'adagok_atalakitott.csv' fájlból
...
# Adatok beillesztése az 'adagok' táblába (adag_id nélkül, mivel az automatikus)
